...
#########################################################################################
#########################################################################################
# New Code for calculating weighted predictions
#########################################################################################
#########################################################################################
...
## plots of actual vs predicted with distance line segments
...
## Loop through a range of k's and store the errors for both raw and weighted
...
## calculate error and plot graph comparing
...
###Below creates the plots showing the distances between k=1 & k=6 

## plot distances for k=1
estXY = predXY(newSignals = onlineSummary[ , 6:12],newAngles = onlineSummary[ , 4] 
                 ,offlineSummary, numAngles = 3, k = 1)


actualXY$estX <- estXY[,1]
actualXY$estY <- estXY[,2]
pdf(paste0("Distance_Plot_Weighted_k1.pdf"))
plotDistance(actualXY)
dev.off()

## plot distance plots for k=6 weighted
weightedEstXY = weightedPredXY(newSignals = onlineSummary[ , 6:12],newAngles = onlineSummary[ , 4] 
                               ,offlineSummary, numAngles = 3, k = 6)

actualXY$estX <- weightedEstXY[,1]
actualXY$estY <- weightedEstXY[,2]
pdf(paste0("Distance_Plot_Weighted_k6.pdf"))
plotDistance(actualXY)
dev.off()
